...
public class LayerInfoDisplayLocalInfoLayers extends TestBase {
	String filepath = "E:\\Selenium scripts\\MCOEDTest\\excelData";
	String filename = "McoedData.xlsx";
	String sheetName = "AnalyzeLocalInfo";
	int excelRowcount = 0;
	...
	/* Test case 3 */
	/* To verify the display of Local Info layer on map. */
	@Test (dataProvider="searchProvider")
	public void displayLocalInfoLayers(String localInfoLayerName, String layerId, String layerTag, String infoPoupTitle, 
		...
		Assert.assertTrue(SeleniumActions.expandLayerInfoLayers("Local Info", excelRowcount, sheetName));

		// To select Local Info layers radio button
		Assert.assertTrue(SeleniumActions.clickRadioButton(localInfoLayerName, radioBtnClassName, excelRowcount, sheetName));
